...
async function loadSettings() {
    ...
    // General settings
    const maximizeOnOpen = document.getElementById('maximizeOnOpen');
    if (maximizeOnOpen)
        maximizeOnOpen.checked = currentSettings.general.maximizeOnOpen;
    const displayThumbs = document.getElementById('displayThumbs');
    if (displayThumbs)
        displayThumbs.checked = currentSettings.general.displayThumbs;
    const rememberLastFilter = document.getElementById('rememberLastFilter');
    ...
    if (defaultDarkMode)
        defaultDarkMode.value = currentSettings.general.defaultDarkMode;
    // Render keybinds
    renderKeybinds();
}
