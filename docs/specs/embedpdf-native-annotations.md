...
- This specification synthesizes the design confirmed on 2026-09-08. Product decisions and test boundaries are confirmed. Issue #66 makes pinned EmbedPDF 2.15.0 the sole production viewer and composes native annotation, save, recovery, and printing by default. See the [issue #66 verification record](../issue-66-verification.md) for automated evidence and the packaged/cross-reader checks that remain pending.
